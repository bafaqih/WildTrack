            ...
            <section className="py-20 bg-white">
                <div className="container-custom">
                    <div className="grid md:grid-cols-2 gap-12">
                        <div
                            className="bg-gradient-to-br from-secondary to-secondary-dark text-white rounded-2xl p-10 shadow-xl"
                            data-aos="fade-right"
                        >
                        ...
                        <div
                            className="bg-gradient-to-br from-accent to-blue-600 text-white rounded-2xl p-10 shadow-xl"
                            data-aos="fade-left"
                        >
